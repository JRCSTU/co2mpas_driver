...
dsp.add_func(
    ...
    outputs=['br_eff_pres'],
    inputs=['gear_box_speeds_in, gear_box_power_out', 'fuel_eng_capacity',
            'min_engine_on_speed']
)
dsp.add_func(
    mean_piston_speed,
...
def get_resistances(type_of_car, car_type, veh_mass, engine_max_power,
    ...
    from .co2mpas import estimate_f_coefficients, veh_resistances, \
        Armax
...
def light_co2mpas_series(gearbox_type, veh_params, gb_type, car_type, veh_mass,
                         ...
                         fuel_type, fuel_turbo, road_loads, sp, gs, sim_step,
                         **kwargs):
    """
    :param gearbox_type:
    :param veh_params:
