...
def simple_run():
    ...
    plt.plot(res['speed'], res['accel'], label=f'Simulation car:{car_id}, DS: {driver_style}, GS:{gs_style}')
    plt.legend()
    ...
    plt.plot(res['speed'], fp, label=f'Simulation car:{car_id}, DS: {driver_style}, GS:{gs_style}')
    plt.legend()
