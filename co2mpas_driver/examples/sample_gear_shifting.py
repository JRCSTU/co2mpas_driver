...
def simple_run():
    ...
    for gear, (speeds, acceleration, fit_coef) in enumerate(zip(speed_per_gear, acc_per_gear, coefs_per_gear)):
    ...
    fig.suptitle('Speed acceleration regression results of degree = ' + str(degree), x=0.54, y=1, fontsize=12)
