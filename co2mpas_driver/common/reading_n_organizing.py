...
def load_db_to_dictionary(name):
    ...
    return: dict of dictionaries, every dict item is a car, every dict key is the car's characteristic's name, and the
    value returned from the key is the value of the characteristic.
