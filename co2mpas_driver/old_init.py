...
from co2mpas_driver.co2mpas import get_full_load, \
    calculate_full_load_speeds_and_powers, estimate_f_coefficients, \
    calculate_full_load_torques

from co2mpas_driver.gear_functions import create_clutch_list, gear_for_speed_profiles
from co2mpas_driver.common.vehicle_specs_class import HardcodedParams

from co2mpas_driver.generic_co2mpas import light_co2mpas_instant
from co2mpas_driver.common.functions import calculate_wheel_power, calculate_wheel_speeds, \
...
@sh.add_function(dsp, outputs=['gear_cut'])
...
def get_cubic_splines_of_speed_acceleration_relationship(gear_box_ratios, speed_per_gear, acc_per_gear, use_cubic=True):
    """
...
def light_co2mpas_series(gearbox_type, veh_params, gb_type, car_type, veh_mass,
                         r_dynamic, final_drive, gear_box_ratios, engine_max_torque,
