...
class Driver:
    ...
    def calculate_fuel_consumption(
        self, speed, acceleration, gear, gear_count, sim_step, slope=0
    ):
        import math
        ...
        veh_wheel_power = func.calculate_wheel_power(
            speed, acceleration, road_loads, self.vehicle_mass, slope
        )
        ...
        gear_box_speeds_in = func.calculate_gear_box_speeds_in_v1(
            gear, final_drive_speed, self.gear_box_ratios, 0
        )
